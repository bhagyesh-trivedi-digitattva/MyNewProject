...
const LoginScreen = ({ navigation }) => {
    const [loginData, setLoginData] = useState({
        identifier: '', // Can be name, email, or phone number
    });
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            // Check if identifier matches name, email, or phone number
            const isMatch =
            ...
            if (isMatch) {
                // Store current user identifier for OTP verification
    ...
    const handleIdentifierBlur = () => {
        validateIdentifier(loginData.identifier);
    };
...
const styles = StyleSheet.create({
    ...
    inputSection: {
        ...
        minHeight: 200, // Ensure minimum height for input section
    },
    inputContainer: {
        marginBottom: 20,
    },
    ...
    spacer: {
        flex: 1,
        minHeight: 20, // Flexible spacer that grows when needed
    },
    actionSection: {
